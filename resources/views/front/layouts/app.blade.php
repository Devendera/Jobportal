...
<head>
    ...
    <title>JobPportal | Find Best Jobs</title>
...
<body data-instant-intensity="mousedown" class="d-flex flex-column min-vh-100">
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">JobPportal</a>
...
<main class="flex-grow-1">
        ...
        <footer class="bg-dark py-3 bg-2">
            <div class="container">
                <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 JobPportal company, all right reserved</p>
            </div>
        </footer>
